...
Boom --- pivot table. Average MPG and horsepower, broken out by cylinder count. Your boss would frame this.
...
The `.groups = "drop"` removes the grouping when you're done. Good habit --- leftover grouping causes sneaky bugs.
...
This is exactly the kind of summary table your manager wants on their desk by Friday. Clean, grouped, sorted, readable.
